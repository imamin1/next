    ...
    <div className="fixed w-full h-screen left-0 top-0 z-20 bg-black/50 flex justify-center items-center">
      <div className="bg-white rounded-lg shadow-md p-6 max-w-md mx-auto">
        <div className="flex items-center mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800">محمد امین شیرزاد</h2>
        ...
        <div className="border-t border-gray-200 pt-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div className="flex items-center">
              ...
              <span className="font-medium">محمد امین</span>
            </div>
            <div className="flex items-center">
              <span className="w-24 text-gray-600">نام خانوادگی:</span>
              <span className="font-medium">شیرزاد</span>
            </div>
            <div className="flex items-center">
              <span className="w-24 text-gray-600">ایمیل:</span>
              <span className="font-medium">mohammadamin.shirzad@example.com</span>
            </div>
            <div className="flex items-center">
